...
function uptime() {
	$.getJSON("json/stats.json", function(result) {
        ...
        var shstr ='<div class="page-padding col-lg-3 col-md-4 col-sm-6 col-12">' +
                       ' <div class="panel panel-block panel-block-sm panel-location">'+
                         ...
                         '   </div>'+
                          ...
                          '  </div>'+
                           ...
                           '     <li><span class="list-label">负载状态:</span> @load%<small>@type</small></li>'+
                         '   </ul>'+
                      '  </div>'+
                   ' </div>';
      ...
      var shinnerhtml='';
          ...
          //----jieshu
			...
			if (!TableRow.length) {
				$("#servers").append(
                    ...
                    "<td style=\"text-align: center;width:4%\" data-title=\"运行状态\" id=\"online4\"><div class=\"progress\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-warning\"><small>加载中</small></div></div></td>" +
                    "<td style=\"width:11%\" data-title=\"节点名\"id=\"name\">加载中</td>" +
                    "<td style=\"width:5%\" data-title=\"类型\"id=\"type\">加载中</td>" +
                    "<!-- td id=\"host\">加载中</td -->" +
                    "<td style=\"width:8%\" data-title=\"服务器位置\"id=\"location\">加载中</td>" +
                    "<td style=\"width:5%\" data-title=\"在线时间\"id=\"uptime\">加载中</td>" +
                    "<td style=\"width:3%\" data-title=\"负载\"id=\"load\">加载中</td>" +
                    "<td style=\"width:4%\" data-title=\"网络(B/s) ↓\"id=\"network_rx\">加载中</td>" +
                    "<td style=\"width:4%\" data-title=\"网络(B/s) ↑\"id=\"network_tx\">加载中</td>" +
                    "<td style=\"width:4%\" data-title=\"流量(B) ↓\"id=\"traffic_in\">加载中</td>" +
                    "<td style=\"width:4%\" data-title=\"流量(B) ↑\"id=\"traffic_out\">加载中</td>" +
                    "<td style=\"width:22%\" data-title=\"内存信息(已使用/总内存)\" id=\"expand_mem\">加载中</td>" +
                    "<td style=\"width:11%\" data-title=\"硬盘信息\" id=\"expand_hdd\">加载中</td>" +
                    "<td style=\"width:5%\" data-title=\"CPU\"id=\"cpu\"><div class=\"progress progress-striped active\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-warning\"><small>加载中</small></div></div></td>" +
                    "<td style=\"width:5%\" data-title=\"RAM\"id=\"memory\"><div class=\"progress progress-striped active\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-warning\"><small>加载中</small></div></div></td>" +
                    "<td style=\"width:5%\" data-title=\"ROM\"id=\"hdd\"><div class=\"progress progress-striped active\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-warning\"><small>加载中</small></div></div></td>" +
                    "</tr>"/* +
                    "<tr class=\"expandRow " + hack + "\"><td class=\"ex_info\" colspan=\"13\"><div class=\"accordian-box\"><div class=\"accordian-body collapse\" id=\"rt" + i + "\">" +
                    "<div class=\"col-md-3 mem_text\" id=\"expand_mem\">加载中</div>" +
                    "<div class=\"col-md-3 hdd_text\" id=\"expand_hdd\">加载中</div>" +
                    "</div></div></td></tr>"*/
				);
			...
			if (!result.servers[i].online4 && !result.servers[i].online6) {
				if (server_status[i]) {
                    ...
                    TableRow.children["network_rx"].innerHTML = "–";
                    TableRow.children["network_tx"].innerHTML = "–";
                    TableRow.children["traffic_in"].innerHTML = "–";
                    TableRow.children["traffic_out"].innerHTML = "–";
                ...
                TableRow.children["network_rx"].innerHTML = netstr;
                ...
                TableRow.children["network_tx"].innerHTML = netstr;
                ...
                TableRow.children["traffic_in"].innerHTML = trafficstr;
                ...
                TableRow.children["traffic_out"].innerHTML = trafficstr;
                ...
                TableRow.children["cpu"].children[0].children[0].innerHTML = "<span>" + result.servers[i].cpu + "%" + "</span>";
                ...
                TableRow.children["memory"].children[0].children[0].innerHTML = "<span>" + Mem + "%" + "</span>";
                TableRow.children["expand_mem"].innerHTML = bytesToSize(result.servers[i].memory_used * 1024, 2) + " / " + bytesToSize(result.servers[i].memory_total * 1024, 2);
                ...
                TableRow.children["expand_hdd"].innerHTML =  bytesToSize(result.servers[i].hdd_used * 1024 * 1024, 2) + " / " + bytesToSize(result.servers[i].hdd_total * 1024 * 1024, 2);
        ...
        if (!error) {
            $("#servers > tr.accordion-toggle").each(function(i) {
                ...
                TableRow.children["network_rx"].innerHTML = "<div class=\"progress progress-striped active\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-error\"><small>错误</small></div></div>";
                TableRow.children["network_tx"].innerHTML = "<div class=\"progress progress-striped active\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-error\"><small>错误</small></div></div>";
                TableRow.children["traffic_in"].innerHTML = "<div class=\"progress progress-striped active\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-error\"><small>错误</small></div></div>";
                TableRow.children["traffic_out"].innerHTML = "<div class=\"progress progress-striped active\"><div style=\"width: 100%;\" class=\"progress-bar progress-bar-error\"><small>错误</small></div></div>";
